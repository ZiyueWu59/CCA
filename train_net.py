...
from cca.engine.trainer import do_train
...
from cca.utils.miscellaneous import mkdir, save_config
...
def main():
    ...
    logger = setup_logger("cca", output_dir, get_rank())
